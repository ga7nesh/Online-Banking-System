<?php
    ...
    if (isset($_POST['CitizenshipNumber'])) {
        ...
        /* storing Citizenship Number in varible using mysqli_real_escape_string function to remove special charaters like double quotes or etc */
        $CitizenshipNo = mysqli_real_escape_string($conn, $_POST['CitizenshipNumber']);

        // sql query to check Citizenship no is available or not
        $query = "SELECT * FROM customer_detail WHERE C_Citizenship_No = '".$CitizenshipNo."'";
