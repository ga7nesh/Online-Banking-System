                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response["Flag"] != "fail") {
                            ...
                            let CitizenshipNo = response["CitizenshipNo"];
                            ...
                            $('#SenderAc').popover({
                                ...
                                <p><strong>Citizenship Number: </strong>${CitizenshipNo}</p> 
    ...
    $("#Amount").on({
        ...
        keyup: function () {
            ...
            if (Amount >= 50) {
                ...
                $("#AmountError").text("Please Enter Minimum 50 dollar");
            }
        }
        ...
        if (SenderAc != "") {
            ...
            if (ReceiverAc != "") {
                ...
                if (Amount >= 50) {
                    $("#AmountError").text("");
                    swal({
                        title: "Are you sure to transfer " + "$" + "   " + Amount,
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    }).then((willDelete) => {
