                        ...
                        <div class="row">
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h3 mb-0">Open Account</h1>
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form id="regForm" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="mb-4" style="margin-top:40px; display:flex; align-items: center; justify-content:center;">
                                                        <input type="submit" class="btn btn-sm btn-success shadow-sm" style="font-size:20px; width: 200px; height:40px;">                                                                                    
                    ...
                    <div class="container-fluid">
                        <div class="row text-muted">
                            <div class="col-6 text-left">
                                <p class="mb-0">
                                    <a href="index.html" class="text-muted light"><strong>Online Banking System
                                        </strong></a> &copy
                                </p>
                            </div>
