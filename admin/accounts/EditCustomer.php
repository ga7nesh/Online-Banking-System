...
if (isset($_POST['edit_btn'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $EditCitizenshipDoc = $row['C_Citizenship_Doc'];
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <a href="../accounts/EditAccount.php"><button name="Edit_another" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="bx bxs-pencil ico"></i> Edit Another</button></a>
